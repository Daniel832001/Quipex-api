In 3 hours I was able to set up the solution using onion architecture and CQRS and then implement the CreateCompanyRecord and GetCompanyRecordByID endpoints.
